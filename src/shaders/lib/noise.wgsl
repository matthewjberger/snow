#define_import_path snow::noise

// Shared procedural noise library.
...
// Ridged noise with derivatives: sharp crests, smooth valleys.
...
// Smooth absolute value, avoiding the derivative discontinuity of abs().
...
// Interleaved gradient noise, the stable per-pixel dither the temporal resolve /
// tolerates.
